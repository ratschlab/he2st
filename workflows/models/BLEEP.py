...
regressor = BLEEP(image_embedding=feature_dim,
                  spot_embedding=selected_genes_bool.sum(),
                  **param)
...
if len(sys.argv) >= 4:
    ...
    validation_data_loader_custom = BLEEPCustomDataLoader(
        out_folder=out_folder,
    ...
    validation_prediction = run_inference_from_dataloader(regressor,
                                                          train_data_loader,
    ...
    test_data_loader_custom = BLEEPCustomDataLoader(
        out_folder=out_folder,
    ...
    test_prediction = run_inference_from_dataloader(regressor,
                                                    train_data_loader,
                                                    train_data_loader_custom.transcriptomics_df.values,
                                                    test_data_loader,
                                                    top_k=top_k)
