...
from src.Hist2ST.model import Hist2ST
from src.Hist2ST.dataloader import Hist2STCustomDataLoader
from src.morphology_model import get_morphology_model_and_preprocess
from src.Hist2ST.utils import run_inference_from_dataloader
...
train_data_loader_custom = Hist2STCustomDataLoader(out_folder,
...
regressor = Hist2ST(fig_size=train_data_loader_custom.patch_size,
...
if len(sys.argv) >= 4:
    ...
    validation_data_loader_custom = Hist2STCustomDataLoader(out_folder,
    ...
    test_data_loader_custom = Hist2STCustomDataLoader(out_folder,
                                                      test_samples_set,
                                                      selected_genes_bool,
                                                      patch_size=train_data_loader_custom.patch_size,
                                                      is_train=False)
