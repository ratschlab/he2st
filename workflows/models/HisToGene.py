...
train_data_loader_custom = HisToGeneCustomDataLoader(out_folder,
                                                     training_samples_set,
                                                     selected_genes_bool,
                                                     is_train=True)


input_size = 3 * (train_data_loader_custom.patch_size**2)
...
regressor = HisToGene(fig_size=train_data_loader_custom.patch_size,
...
if len(sys.argv) >= 4:
    ...
    validation_data_loader_custom = HisToGeneCustomDataLoader(out_folder,
    ...
    test_data_loader_custom = HisToGeneCustomDataLoader(out_folder,
                                                        test_samples_set,
                                                        selected_genes_bool,
                                                        patch_size=train_data_loader_custom.patch_size,
                                                        is_train=False)
